            ...
            <div class="col-lg-12">
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        <h5 class="card-title m-0"><b>Data Dokter</b></h5>
                        <div class="float-right">
                            <a href="{{ url('/') }}">Home</a> / Dokter
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <button type="button" id="btnAddData" class="btn btn-primary btn-sm mb-2" data-toggle="modal" data-target="#modal_"><i class="fa fa-plus"></i> Tambah Data Dokter</button>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="ModalLabel"><b>Tambah Data Dokter</b></h5>
...
<script>
    ...
    $('#btnAddData').on('click',function(event){
        ...
        $("#ModalLabel").html('Tambah Data Dokter')
        emptyField();
    });
    ...
    function edit(DokterID){
        $("#modal_").modal('show');
        $("#ModalLabel").addClass("font-weight-bold")
        $("#ModalLabel").html('Edit Data Dokter')
        $.ajax({
            type : "GET",
            url: "{{ url('dokter')}}"+"/"+DokterID+"/"+"edit",
            success: function (ajaxData) {
                $("#id_").val(ajaxData.id)
    ...
    function del(DokterID){
        if(confirm('Anda Yakin Menghapus Data?')){
            $.ajax({
                type : "DELETE",
                url: "{{ url('dokter')}}"+'/'+DokterID,
                success: function (ajaxData) {
                    if(ajaxData == "1"){
