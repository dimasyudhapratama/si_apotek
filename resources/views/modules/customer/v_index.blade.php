            ...
            <div class="col-lg-12">
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        <h5 class="card-title m-0"><b>Data Customer</b></h5>
                        <div class="float-right">
                            <a href="{{ url('/') }}">Home</a> / Customer
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <button type="button" id="btnAddData" class="btn btn-primary btn-sm mb-2" data-toggle="modal" data-target="#modal_"><i class="fa fa-plus"></i> Tambah Data Customer</button>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="ModalLabel"><b>Tambah Data Customer</b></h5>
...
<script>
    ...
    $('#btnAddData').on('click',function(event){
        ...
        $("#ModalLabel").html('Tambah Data Customer')
        emptyField();
    });
    ...
    function edit(CustomerID){
        $("#modal_").modal('show');
        $("#ModalLabel").addClass("font-weight-bold")
        $("#ModalLabel").html('Edit Data Customer')
        $.ajax({
            type : "GET",
            url: "{{ url('customer')}}"+"/"+CustomerID+"/"+"edit",
            success: function (ajaxData) {
                $("#id_").val(ajaxData.id)
