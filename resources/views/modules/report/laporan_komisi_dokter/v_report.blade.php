            ...
            <div class="col-lg-12">
                <div class="card card-primary card-outline">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <p id="report_description" class="font-weight-bold"></p>
...
<script>
    ...
    function loadReport(){
        ...
        $("#report_description").text("Perhitungan Komisi Dokter Bulan "+ month +" - "+ year)
                    ...
                    $("#table_output").append(
                        "<tr>"+
                            ...
                            "<td class='text-center'>"+
                                "<a href='{{ url('/detail_komisi_bulanan_dokter') }}/"+data[i].id+"/"+year+"/"+month+"' class='btn btn-sm btn-primary'>"+
                                    "<i class='fa fa-eye' style='color:white'></i>"+
                                "</a>"+
                            // "<button type='button' class='btn btn-sm btn-primary' onclick='detailKomisiDokter()'><i clas></i></button>"+
                            "</td>"+
                        "</tr>"
                    );
