            ...
            <div class="col-lg-12">
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        <h5 class="card-title m-0"><b>Laporan Penjualan</b></h5>
                        <div class="float-right">
                            <a href="{{ url('/') }}">Home</a> / Laporan Penjualan
                        </div>
                    </div>
                    <div class="card-body">
                        ...
                        <table class="table table-sm table-striped table-bordered" id="table_view">
                            <thead>
                                <tr>
                                    ...
                                    <td class="font-weight-bold text-center">Payment </td>
                                    <td class="font-weight-bold text-center">Jatuh Tempo</td>
...
<script>
    ...
    //Load Data With Parameter From Filter Modal
    ...
    function loadDataTable(){
        ...
        $("#table_view").DataTable({
            ...
            order:[2,"desc"],
            ajax : { 
                url : "{{ url('/laporan_penjualan/data') }}",
                type : "post",
                data : {
    ...
    function detail(transaksiID){
        window.open("{{ url('detail_penjualan') }}"+"/"+transaksiID,"_self")
    }
