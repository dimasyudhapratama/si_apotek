            ...
            <div class="col-lg-12">
                <div class="card card-primary card-outline">
                    <div class="card-header">
                        <h5 class="card-title m-0"><b>Laporan Return Pembelian</b></h5>
                        <div class="float-right">
                            <a href="{{ url('/') }}">Home</a> / Laporan Return Pembelian
                        </div>
                    </div>
                    <div class="card-body">
...
<script>
    ...
    function loadDataTable(){
        ...
        $("#table_view").DataTable({
            ...
            order:[2,"desc"],
            ajax : { 
                url : "{{ url('/laporan_return_pembelian/data') }}",
                type : "post",
                data : {
    ...
    function detail(transaksiID){
        window.open("{{ url('detail_return_pembelian') }}"+"/"+transaksiID,"_self")
    }
