                    ...
                    <div class="card-body">
                        ...
                        <div id="div_appended_target">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <h2 class="font-weight-bold" id="grand_total_idr">Rp. 0</h2>
                                </div>
                                <div class="col-md-12">
                                    <hr>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-10">
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <small class="font-weight-bold">Kembalian</small>
...
<script>
    ...
    function save(tipe){
        // var subtotal = $('input[name="sub_total[]"]').map(function(){ return this.value; }).get()
